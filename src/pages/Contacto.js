  ...
  return (
    <>
      <main className='main-bg text-light justify-center'>
        <div className='bg blur container-width col align-center gap-15 ypad-10'>
          <div className='Columna-Contacto gap-15 space-around xpad-10'>

            <div className='Info'>
              <h2>Titulo Info</h2>
              <div className='bg-dark br3 xpad-10 ypad-5 gap-15 col'>
                <p className='text-indent'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus venenatis lectus tellus. Vestibulum ut mattis nunc, in sodales urna. Proin ipsum purus, vehicula ut tempus quis, congue ut mi. Pellentesque eget ante eros. Morbi tristique tincidunt finibus. Nullam malesuada aliquet ultrices.</p>
                <p>Nam ut quam non ligula pretium rhoncus. Nullam metus leo, ullamcorper eu odio in, fermentum malesuada risus. In convallis viverra nibh, quis scelerisque ligula scelerisque id. Vivamus gravida ac lacus sed rhoncus. Fusce vitae eros metus. Interdum et malesuada fames ac ante ipsum primis in faucibus. Nulla venenatis condimentum ligula sed semper. Suspendisse potenti. Curabitur pulvinar pulvinar nulla in porta.
                </p>
              </div>
            </div>

            <div className='Info col'>
              <h2 className='align-start'>Titulo Form</h2>
